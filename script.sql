...
-- ATTENTION! I can NOT create bookings before because it depends on customers and hotels
...
-- ATTENTION! Notice that we can NOT fill the bookings table until there are some customers and hotels
-- 
...
-- show all info in customers
SELECT * FROM customers;

-- show all info in hotels
SELECT * FROM hotels;

-- show all info in bookings
...
-- show me ONLY THE NAME from all the customers that live in UK
select name from customers where country='UK'

-- show me THE NAME and  from all the customers that live in UK
